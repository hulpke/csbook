...
the indefinite integrals.} We therefore often will express indefinite
...
use. This process is called \defini{integration by parts}
...
\anngraphics{8cm}{pic/areaunder.png}{A graph is plotted on a coordinate
plane. It has a y-intercept at $(0,4)$, and from there increases, decreases,
and then increased again. Two vertical lines are drawn at $x=1$ and $x=8$.
The area below the curve and between the two vertical lines is shaded.}
\end{center}
...
\anngraphics{3cm}{pic/riemannsum1.png}{Six coordinate planes illustrate
approximations of the area under a given by sketching 1, 2, 3, 4, 10, and 25
shaded rectangles. As the number of rectangles increases, the shaded
rectangles become more representative of the actual area underneath the
curve.}
\end{minipage}&\begin{minipage}[t]{3.5cm}
2 rectangles: $34.84$\\
%\includegraphics[width=3cm]{pic/riemannsum2.png}
\anngraphics{3cm}{pic/riemannsum2.png}{approximation by 2 rectangles}
\end{minipage}&\begin{minipage}[t]{3.5cm}
3 rectangles: $34.69$\\
\anngraphics{3cm}{pic/riemannsum3.png}{approximation by 3 rectangles}
\end{minipage}\\
\\
\begin{minipage}[t]{3.5cm}
4 rectangles: $34.53$\\
%\includegraphics[width=3cm]{pic/riemannsum4.png}
\anngraphics{3cm}{pic/riemannsum4.png}{approximation by 4 rectangles}
\end{minipage}&\begin{minipage}[t]{3.5cm}
10 rectangles: $34.11$\\
%\includegraphics[width=3cm]{pic/riemannsum10.png}
\anngraphics{3cm}{pic/riemannsum10.png}{approximation by 10 rectangles}
\end{minipage}&\begin{minipage}[t]{3.5cm}
25 rectangles: $33.91$\\
%\includegraphics[width=3cm]{pic/riemannsum25.png}
\anngraphics{3cm}{pic/riemannsum25.png}{approximation by 25 rectangles}
\end{minipage}\\
\end{tabular}
\end{center}
...
\anngraphics{6cm}{pic/fundthm.png}{The area beneath a curve is shaded
between the vertical lines at $1$ and $x$. An additional vertical line is
given at $x+h$ to the right of $x$, which extends the area under the curve
which is shaded.}
\end{center}
