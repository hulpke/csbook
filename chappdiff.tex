...
\anngraphics{8cm}{pic/Kurdi2.png}{The graph of the derivative, $f'(x)$, is
...
\anngraphics{8cm}{pic/Kurvendiskussion.png}{The graph of the second
...
\anngraphics{8cm}{pic/FuncSynth.png}{The figures constructed in the table are
...
\anngraphics{6cm}{pic/newtonmeth.png}{The Newton Method is illustrated on a
...
\anngraphics{10cm}{pic/GrowthOrders.png}{Illustrating the varying growth of
functions}
\end{center}
